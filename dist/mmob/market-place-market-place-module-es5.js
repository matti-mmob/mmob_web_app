(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["market-place-market-place-module"], {
    ...
    /***/
    function XJJU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _exploring_market_place_exploring_market_place_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./exploring-market-place/exploring-market-place.component */
      "xxFq");
      /* harmony import */
      ...
      var _market_place_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./market-place-routing.module */
      "sZ40");
      ...
      MarketPlaceModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: MarketPlaceModule
      });
      MarketPlaceModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function MarketPlaceModule_Factory(t) {
          return new (t || MarketPlaceModule)();
        },
        imports: [[_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _layout_layout_module__WEBPACK_IMPORTED_MODULE_3__["LayoutModule"], _market_place_routing_module__WEBPACK_IMPORTED_MODULE_4__["MarketPlaceRoutingModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](MarketPlaceModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MarketPlaceModule, [{
    ...
    /***/
    function sZ40(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _exploring_market_place_exploring_market_place_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./exploring-market-place/exploring-market-place.component */
      "xxFq");
      ...
      var routes = [{
        ...
        children: [{
          path: '',
          component: _exploring_market_place_exploring_market_place_component__WEBPACK_IMPORTED_MODULE_3__["ExploringMarketPlaceComponent"]
        }]
      }];
      ...
      MarketPlaceRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: MarketPlaceRoutingModule
      });
      MarketPlaceRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function MarketPlaceRoutingModule_Factory(t) {
          return new (t || MarketPlaceRoutingModule)();
        },
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MarketPlaceRoutingModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
    ...
    /***/
    function xxFq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ExploringMarketPlaceComponent", function () {
        return ExploringMarketPlaceComponent;
      });
      /* harmony import */
      ...
      var _c2 = function _c2() {
        return ["/utilities/accessUtilities"];
      };
      ...
      var ExploringMarketPlaceComponent = /*#__PURE__*/function () {
        function ExploringMarketPlaceComponent() {
          _classCallCheck(this, ExploringMarketPlaceComponent);

          this.navigationUrlConstants = src_app_shared_constant_navigation_url_constant__WEBPACK_IMPORTED_MODULE_1__["NavigationUrl"];
        }

        _createClass(ExploringMarketPlaceComponent, [{
          key: "ngOnInit",
      ...
      ExploringMarketPlaceComponent.ɵfac = function ExploringMarketPlaceComponent_Factory(t) {
        return new (t || ExploringMarketPlaceComponent)();
      };

      ExploringMarketPlaceComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: ExploringMarketPlaceComponent,
        selectors: [["app-exploring-market-place"]],
        decls: 61,
        vars: 31,
        consts: [[1, "market-place"], [1, "market-place-header"], [1, "market-place-img"], ["alt", "Market Place image", 3, "src"], ["type", "search", 1, "market-place-search-box"], [1, "market-place-boxes"], [1, "row", "justify-content-around", "mt-4"], [1, "col-sm", "insurance", "box"], [3, "routerLink"], ["alt", "Insurance image", 3, "src"], [1, "col-sm", "merchants", "box"], ["alt", "Merchants image", 3, "src"], [1, "col-sm", "utilities", "box"], ["alt", "Utilities image", 3, "src"], [1, "row", "justify-content-around"], [1, "col-sm", "lending", "box"], ["alt", "Lending image", 3, "src"], [1, "col-sm", "investments", "box"], ["alt", "Investments image", 3, "src"], [1, "col-sm", "credit", "box"], ["href", "#"], ["alt", "Credit Score image", 3, "src"]],
        template: function ExploringMarketPlaceComponent_Template(rf, ctx) {
          if (rf & 1) {
...
//# sourceMappingURL=market-place-market-place-module-es5.js.map