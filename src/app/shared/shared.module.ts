...
@NgModule({
  ...
  exports: [AssetsPathPipe, ShowErrorsComponent, ConfirmationPopupComponent, IframeComponent, TermsConditionsComponent, PrivacyComponent, ReactiveFormsModule, FormsModule, InputControlMessagesComponent, CommonModule],
